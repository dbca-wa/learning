...
function theme_dpawbs3_process_css($css, $theme) {

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_dpawbs3_set_logo($css, $logo);
    ...
    $css = theme_dpawbs3_set_customcss($css, $customcss);

    return $css;
}


function theme_dpawbs3_set_logo($css, $logo) {
 ...
 * @return bool
 */
function theme_dpawbs3_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 */
function theme_dpawbs3_set_customcss($css, $customcss) {
