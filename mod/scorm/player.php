...
$name = false;
echo "<button type=\"button\" onclick=\"goFullscreen('scormpage'); return false\" class=\"btn btn-default pull-right btn-small\" title=\"Display SCORM fullscreen\"><i class=\"icon-expand fa fa-arrows-alt\"></i></button><div class=\"clearfix\"></div>";
...
$PAGE->requires->yui_module('moodle-core-checknet', 'M.core.checknet.init', array(array(
    ...
    'timeout' => 10000,	// Up from default 2000ms
    'frequency' => 10000,	// Up from default 5000ms
)));
echo $OUTPUT->footer();
