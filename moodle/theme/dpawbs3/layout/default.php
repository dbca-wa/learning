...
<ul class="nav navbar-nav  related-nav pull-left">
...
<header class="moodleheader">
    ...
    <a href="<?php echo $CFG->wwwroot ?>" class="logo"><?php echo $OUTPUT->page_heading(); ?></a>
    </div>
</header>

<nav role="navigation" class="navbar navbar-default" id="topmainnav">
    <div class="container-fluid">
    ...
    <div id="topmainnav" class="navbar-collapse collapse">
...
<div id="page" class="container-fluid">
    <header id="page-header" class="clearfix">
        <div id="page-navbar" class="clearfix">
            <nav class="breadcrumb-nav" role="navigation" aria-label="breadcrumb"><?php echo $OUTPUT->navbar(); ?>
</nav>
